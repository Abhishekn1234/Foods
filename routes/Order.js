...
router.get('/success', async (req, res) => {
  try {
    ...
    await Order.updateOne({ _id: orderId }, { $set: { paymentStatus: 'paid', paymentId } });
...
// Route to handle successful Razorpay payment
...
// Route to process Razorpay payment
